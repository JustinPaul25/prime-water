<script setup>
    ...
    <template>
        ...
        <AuthenticatedLayout>
            ...
            <div class="py-12">
                <!-- <vue-qrcode value="http://prime-water.test/dashboard" :options="{ width: 200 }"></vue-qrcode> -->
                            ...
                            <div>
                                <dl class="mt-2 divide-y divide-gray-200 border-t border-b border-gray-200">
                                    ...
                                    <div class="flex justify-between py-3 text-sm font-medium">
                                        ...
                                        <dd class="whitespace-nowrap text-gray-900 font-bold">P0.00</dd>
                                    </div>
                                    ...
                                    <div class="flex justify-between py-3 text-sm font-medium">
                                        ...
                                        <dd class="whitespace-nowrap text-gray-900 font-bold text-xl">P0.00</dd>
                                    </div>
                                </dl>
                            </div>
                            ...
                            <div class="px-4 sm:px-6 lg:px-8 pt-4">
                                <div class="sm:flex sm:items-center">
                                    <div class="sm:flex-auto">
                                        <h1 class="text-xl font-semibold text-gray-900">Reading Record</h1>
                                    </div>
                                </div>
                                <div class="-mx-4 mt-10 ring-1 ring-gray-300 sm:-mx-6 md:mx-0 md:rounded-lg">
                                    <table class="min-w-full divide-y divide-gray-300">
                                        <thead>
                                            <tr>
                                                <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Previous Reading</th>
                                                <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell">Current Reading</th>
                                                <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell">Consumed Cu. M</th>
                                                <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell">Price/Cu. M</th>
