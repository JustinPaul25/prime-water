            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6">
                <div class="flex items-center justify-between py-6 md:justify-start md:space-x-10">
                    ...
                    <div class="-my-2 -mr-2 md:hidden">
                        <a :href="route('login')" class="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-primary-blue px-4 py-2 text-base font-medium text-white shadow-sm hover:opacity-75">Sign in</a>
                    </div>
                    <div v-if="canLogin" class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                        <a :href="route('login')" class="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-primary-blue px-4 py-2 text-base font-medium text-white shadow-sm hover:opacity-75">Sign in</a>
                    </div>
                </div>
            </div>
        ...
        <main class="lg:relative">
            ...
            <div class="px-4 sm:px-8 lg:w-1/2 xl:pr-16">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
                    <span class="block xl:inline">Panabo Water District - </span>
                    <span class="block text-primary-blue xl:inline">Prime Water</span>
                </h1>
            ...
            <img class="absolute inset-0 h-full w-full object-cover" src="https://scontent.fdvo2-2.fna.fbcdn.net/v/t39.30808-6/306084674_456569863181681_2999585402834425970_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=8bfeb9&_nc_ohc=RnZ-55Kgy8AAX_60aAA&_nc_ht=scontent.fdvo2-2.fna&oh=00_AT8A2N7CU-s6FiQdlBevL4VEdekBph0fp01IQz2_j4fMww&oe=6330E7D4" alt="">
            </div>
        </main>
    </div>
